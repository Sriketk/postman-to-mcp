...
def PostShipment(token: str, vehicle_id: str = " ", shipment_timestamp: datetime = " ", planned_route: str = " ", drivers: List[str] = " ", stops: object = " ", stops.estimated_arrival_time: Optional[datetime] = " ", stops.orders: List[str] = " ") -> Dict:
