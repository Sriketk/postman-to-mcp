...
def PostWorkOrder(token: str, scheduled_datetime: datetime = " ", machine_id: int = " ", bom_hdr_pk: int = " ", expected_qty_to_create: int = " ", lot_number: Optional[str] = "null", name: str = " ", note: Optional[str] = "null", pressure: Optional[float] = "null", temperature: Optional[float] = "null", sequence: Optional[int] = "null", processing_duration: Optional[float] = "null", ref_field_1: Optional[str] = " ", ref_field_2: Optional[str] = " ", ref_field_3: Optional[str] = "null") -> Dict:
