...
def PostBom(token: str, active: Literal["0", "1"] = " ", effective_date: datetime = " ", is_primary: Literal["0", "1"] = " ", item_id: int = " ", nickname: str = " ", qty_to_create: int = " ", work_instructions: str = " ") -> Dict:
    """This endpoint appears to be for creating or updating a Bill of Materials (BOM) item. It includes fields for activation status, effective date, primary status, item identification, nickname, quantity to create, and work instructions."""
...
def PostBomDtl(token: str, bom_id, qty: int = "1", qty_uom_id: int = " ", notes: str = " ", item_id: int = " ") -> Dict:
    """This endpoint appears to be for adding or updating a Bill of Materials (BOM) detail item. It allows specifying the quantity, unit of measure, notes, and the item being added to the BOM."""
...
def PutBomDtlW/Category(token: str, bom_id, bom_detail_id, qty: int = "1", qty_uom_id: int = "18", notes: str = " ", item_category_id: int = " ") -> Dict:
    """This endpoint appears to be related to updating or creating a Bill of Materials (BOM) detail. It includes quantity, unit of measure, notes, and item category information."""
